...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    IUniswapV2Pair immutable uniswapV2Pair_USDC_WETH; // Pool3
    ...
    constructor() {
        ...
        uniswapV2Pair_USDC_WETH = IUniswapV2Pair(uniswapV2Factory.getPair(address(WETH), address(USDC))); // Pool3
    ...
    function uniswapV2Call(
        ...
        (uint256 reserve_USDC_Pool, uint256 reserve_WETH_Pool, ) = uniswapV2Pair_USDC_WETH.getReserves(); // Pool3

        //console.log("uniswapV2Pair(%s): USDC <> WETH", address(uniswapV2Pair_USDC_WETH));
        //console.log("reserve USDC: %s", reserve_USDC_Pool);
        //console.log("reserve WETH: %s", reserve_WETH_Pool);
        ...
        // Repay collateral_ETH to flash loan debt USDC/WETH pool directly
        ...
        //console.log("repay_ETH : %s", repay_WETH);
